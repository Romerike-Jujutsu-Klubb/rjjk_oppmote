...
public class OppmoteActivity extends org.ruboto.RubotoActivity {
    ...
    private void initJRuby(final boolean firstTime) {
        new Thread(new Runnable() {
            public void run() {
                final boolean jrubyOk = Script.setUpJRuby(OppmoteActivity.this);
                if (jrubyOk) {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            if (firstTime) {
                                ...
                                Toast.makeText(OppmoteActivity.this,"Failed to initialize Ruboto Core.",Toast.LENGTH_SHORT).show();
                                try {
